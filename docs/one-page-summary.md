...
> **The core question:** What meaningful thing are we landing this week, and what do we need to learn or finish to make that happen?

---

## WORK LANES + OUTCOME LAYER
...
| | | |
|---|---|---|
| **2 wks** | **Route Planning** (60 min) | Keep the next 2-4 weeks shaped enough that weekly steering does not become backlog grooming. |
